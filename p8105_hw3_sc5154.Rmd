...
For snowfall, the most commonly observed values are: `r most_snowf$snow` with `r most_snow$n_obs` observations. That's probably because the New York State does not often snow and some records may be missing.
